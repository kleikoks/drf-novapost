...
class SettlementType(models.Model):
    title = models.CharField(verbose_name="Тип населеного пункту", max_length=255, db_index=True)
    short_desc = models.CharField(
        verbose_name="Скорочено",
        max_length=255,
        null=True,
        blank=True
    )
    ref = models.CharField(verbose_name="Ref", max_length=255, primary_key=True)
...
class WarehouseType(models.Model):
    title = models.CharField(verbose_name="Тип відділення", max_length=255, db_index=True)
    ref = models.CharField(verbose_name="Ref", max_length=255, primary_key=True)
...
class Warehouse(models.Model):
    ...
    short_address = models.CharField(verbose_name="Короткий адрес", max_length=255)
    ref = models.CharField(verbose_name="Ref", max_length=255, primary_key=True)
    type = models.ForeignKey(
        verbose_name="Тип відділення",
        on_delete=models.SET_NULL,
